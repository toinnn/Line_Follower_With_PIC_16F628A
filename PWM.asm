...
;OS MOTORES TEEM SUA VELOCIDADE ALTERADA usando PWM AFIM DE CORRIGIR A DIREÇÃO 
;DO CARRO
;Nesta entrega Parcial está apenas a implementação do PWM 

;PARA CONTROLAR QUAL O NÍVEL DE TENSÃO APLICADO NO MOTOR USE AS VARIÁVEIS
;PWM_ESQ E PWM_DIR ,VARIANDO DE 0 A 255 . 
...
INICIO:
    ...
    ;PWM ESTÁ DISCRETIZADO EM 256 NÍVEIS, SENDO 0 O MENOR VALOR DE TENSÃO E 255 
    ;O VALOR DE TENSÃO MÁXIMO , NESTE CASO IGUAL AO DE PORTA(5V)
    ;O MOTOR DIR SEGUE A MESMA LÓGICA 
    PWM_ESQ EQU 0x8F;   NO MOTOR ESQ OS NÍVEIS VÃO DE 0 A 255 
    PWM_DIR EQU 0x90;   NO MOTOR DIR OS NÍVEIS VÃO DE 0 A 255
		    ; PARA CALCULAR O VALOR MÉDIO DE TENSÃO USE :
		    ; U = (5/256)*(NÍVEL + 1) NO MOTOR ESQ
